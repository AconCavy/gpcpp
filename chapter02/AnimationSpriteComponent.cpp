...
AnimationSpriteComponent::AnimationSpriteComponent(class Actor *Owner,
                                                   int DrawOrder)
    : SpriteComponent(Owner, DrawOrder), CurrentFrame(0), AnimationFPS(24) {}
...
void AnimationSpriteComponent::setAnimationTextures(
